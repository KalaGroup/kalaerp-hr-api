...
namespace KalaGenset.ERP.HR.Core.Validation.DailyAttendance
{
    ...
    public class UpdateDailyAttendanceValidator : AbstractValidator<UpdateDailyAttendanceRequest>
    {
        private readonly KalaDbContext _context;
        public UpdateDailyAttendanceValidator(KalaDbContext context)
        {
            _context = context;
            ...
            RuleFor(x => x.AttendanceShiftId)
                .NotNull().WithMessage("AttendanceShiftId is required.");
