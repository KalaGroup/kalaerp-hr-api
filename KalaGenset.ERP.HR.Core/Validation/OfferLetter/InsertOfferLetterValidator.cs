...
{
    public class InsertOfferLetterValidator : AbstractValidator<InsertOfferLetterRequest>
    {
        private readonly KalaDbContext _context;
        public InsertOfferLetterValidator(KalaDbContext context)
        {
            _context=context;

            RuleFor(x => x.OfferLetterPositionId)
