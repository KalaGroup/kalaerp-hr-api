...
{
    public class InsertRecruitmentMasterValidator : AbstractValidator<InsertRecruitmentMasterRequest>
    {
        private readonly KalaDbContext _context;
        public InsertRecruitmentMasterValidator(KalaDbContext context) 
        { 
             _context = context;
