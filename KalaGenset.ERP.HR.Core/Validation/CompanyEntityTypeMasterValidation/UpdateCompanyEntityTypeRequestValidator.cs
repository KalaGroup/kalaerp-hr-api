...
{
    public class UpdateCompanyEntityTypeRequestValidator : AbstractValidator<UpdateCompanyEntityTypeMasterRequest>
    {
        private readonly KalaDbContext _context;
        public UpdateCompanyEntityTypeRequestValidator(KalaDbContext context)
        {
            _context = context;
