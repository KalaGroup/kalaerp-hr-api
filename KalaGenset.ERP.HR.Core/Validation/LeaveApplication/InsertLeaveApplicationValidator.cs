...
{
    public class InsertLeaveApplicationValidator : AbstractValidator<InsertLeaveApplicationRequest>
    {
        private readonly KalaDbContext _context;
        public InsertLeaveApplicationValidator(KalaDbContext context)
        {
            _context = context;
